...
function initShaders() {
    ...
    shaderPrograms[5].specularUniform = gl.getUniformLocation(shaderPrograms[5], "uSpecularColor");
    ...
    shaderPrograms[6].specularUniform = gl.getUniformLocation(shaderPrograms[6], "uSpecularColor");
    gl.useProgram(shaderPrograms[6]);
    gl.uniform1f(shaderPrograms[6].exponentUniform, 50.0);

    // Microfacet shading
    shaderPrograms[7].specularUniform = gl.getUniformLocation(shaderPrograms[7], "uSpecularColor");
...
function setUniforms(prog) {
    ...
    gl.uniform3fv(prog.specularUniform, specularColor);
