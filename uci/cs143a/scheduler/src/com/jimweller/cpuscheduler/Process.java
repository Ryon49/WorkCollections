...
public class Process{
    ...
    /** The measure of memory required for execution */
    long memSize=0;
    ...
    /** A way to see if a process is ignored because of memory constrains */
     ...
     */
    Process(long b, long d, long p, long s){
        nextPID++;
        PID = nextPID;
        burst = b;
        initBurst = burst;
     ...
     */
    public void println(){
        System.out.println("PID " + PID + " b" + burst + " ignored" + ignored + " p" +
                priority +  " a" + memSize +  " s" +
                arrival + " s" + start +  " f" +
                finish + " w" + wait +  " r" +
                response);
    ...
    /**
     * Get the value of memSize.
     * @return Value of memSize.
     */
    public long getMemSize() {return memSize;}
     ...
     * @param v  Value to assign to finished.
     */
