...
class Board extends Observable {
    ...
    Board() {
        ...
        // FIXME?
        _board = constructNewBoard();

    }

    private PieceColor[][] constructNewBoard() {
        return new PieceColor[][]{
                {PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK},
                {PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK, PieceColor.BLACK},
                {PieceColor.BLACK, PieceColor.BLACK, PieceColor.EMPTY, PieceColor.WHITE, PieceColor.WHITE},
    ...
    String toString(boolean legend) {
        ...
        for (PieceColor[] row: _board) {
            for (PieceColor piece: row) {
                innerJoiner.add(piece.shortName());
            }
        ...
        out.format(outerJoiner.toString());
